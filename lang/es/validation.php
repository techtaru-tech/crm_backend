...
|--------------------------------------------------------------------------
|
| Spanish (es) translation of the Laravel framework `validation.php`
| lines.  Consumed every time a `FormRequest`, Filament form or
| Validator instance produces an error message.
|
