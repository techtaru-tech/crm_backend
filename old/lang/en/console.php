...
return [
    'check_updates' => [
        'no_server_configured' => 'No update server URL configured (LEADHUB_UPDATE_SERVER).',
        'server_error'         => 'Update server returned error: :status',
        'update_available'     => 'Update available: :current → :latest',
        'up_to_date'           => 'Up to date (v:current).',
        'check_failed'         => 'Failed to check for updates: :message',
    ],
];
