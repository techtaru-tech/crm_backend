...
<?php $component->withAttributes([]); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/views/filament/pages/onboarding-wizard.css')); ?>">
    <div class="ow-hero">
        <div class="ow-hero-row">
            ...
            <div>
                <h2 class="ow-hero-title"><?php echo e(__('filament/onboarding_wizard.hero_title')); ?></h2>
                <p class="ow-hero-sub"><?php echo e(__('filament/onboarding_wizard.hero_subtitle')); ?></p>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/techtaru/crm.techtaru.in/resources/views/filament/pages/onboarding-wizard.blade.php ENDPATH**/ ?>